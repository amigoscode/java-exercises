...
public class ReduceExercise {
    ...
    public static void main(String[] args) {
        ...
        //           Print the result
        double totalPrice = orders.stream().map(o -> o.price() * o.quantity()).reduce(0.0, Double::sum);
        ...
        tags.stream().reduce((a, b) -> a + ", " + b).ifPresent(System.out::println);
        ...
        BinaryOperator<Order> higherTotal = (a, b) ->
                a.price() * a.quantity() >= b.price() * b.quantity() ? a : b;
        orders.stream().reduce(higherTotal).ifPresent(System.out::println);
        ...
        //           Print the result
        double totalRevenue = orders.parallelStream().reduce(0.0, (sum, o) -> sum + o.price() * o.quantity(), Double::sum);
