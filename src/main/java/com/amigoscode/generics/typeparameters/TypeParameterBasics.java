package com.amigoscode.generics.typeparameters;
...
public class TypeParameterBasics {
    ...
    public static void main(String[] args) {
        ...
        // stringContainer.setValue(123); // Compiler rejects this because 123 is an Integer, not a String.
        // The Container<String> only accepts String values for setValue().
        stringContainer.setValue("Updated Generics");
        System.out.println(stringContainer);
