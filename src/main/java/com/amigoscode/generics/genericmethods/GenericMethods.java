package com.amigoscode.generics.genericmethods;
...
public class GenericMethods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Last: " + getLast(names));

        List<String> withNulls = Arrays.asList("A", null, "B", null, "C");
        System.out.println("Filtered: " + filterNulls(withNulls));

        System.out.println("Contains 'World': " + contains(strings, "World"));
        System.out.println("Contains 6: " + contains(integers, 6));
        ...
        // The compiler infers T from the arguments automatically (type inference).
        printArray(strings);
        System.out.println(contains(integers, 3));
