package com.amigoscode.testing.exceptions;
...
class BankAccountTest {
    ...
    void testTransfer() {
        BankAccount second = new BankAccount("ACC-002", 50.0);
        account.transfer(second, 40.0);
        assertThat(account.getBalance()).isEqualTo(60.0);
        assertThat(second.getBalance()).isEqualTo(90.0);
    }
    ...
    @Test
    @DisplayName("Insufficient funds exception message")
    void testInsufficientFundsMessage() {
    ...
    @Test
    @DisplayName("Multiple error scenarios throw IllegalArgumentException")
    void testMultipleErrorScenarios() {
